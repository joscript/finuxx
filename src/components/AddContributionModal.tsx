...
export default function AddContributionModal({
  ...
  const handleSubmit = () => {
    ...
    const contribution: Omit<GoalContribution, "id"> = {
      goalId: goal.id,
      accountId: selectedAccount ? String(selectedAccount.id) : undefined,
  ...
  const isValidAmount =
    parsedAmount > 0 && (!selectedAccount || parsedAmount <= selectedBalance);
          ...
          >
            ...
            <View className="mb-6">
              ...
              <View
                ...
                style={{
                  borderWidth:
                    selectedAccount && parsedAmount > selectedBalance ? 2 : 0,
                  borderColor: "#ef4444",
                }}
              >
              ...
              {selectedAccount && parsedAmount > selectedBalance && (
              ...
              {remainingAmount > 0 && (
                <Pressable
                  onPress={() =>
                    setAmount(
                      selectedAccount
                        ? Math.min(remainingAmount, selectedBalance).toString()
                  ...
                  {selectedAccount ? (
                    <View className="flex-row items-center">
                      <View
                        ...
                        style={{
                          backgroundColor: `${selectedAccount.iconColor || "#6b7280"}20`,
                        }}
                      >
                        <Ionicons
                          name={(selectedAccount.icon as any) || "wallet"}
                          size={20}
                          color={selectedAccount.iconColor || "#6b7280"}
                        />
                      </View>
                      <View>
                      ...
                      return (
                        ...
                        >
                          <View
                            className="w-10 h-10 rounded-xl items-center justify-center mr-3"
                            style={{
                              backgroundColor: `${account.iconColor || "#6b7280"}20`,
                            }}
                          >
                            <Ionicons
          ...
          <View className="px-5 pb-5 pt-3 border-t border-gray-100 dark:border-gray-800">
            <AnimatedPressable
              ...
              className={`rounded-2xl py-5 items-center justify-center ${
                isFormValid ? "bg-emerald-500" : "bg-gray-200 dark:bg-gray-700"
              }`}
            >
              <View className="flex-row items-center">
                <Ionicons
