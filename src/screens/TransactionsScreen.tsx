...
import type { Transaction, TransactionGroup, FilterOptions } from '../components/transactions';
...
export default function TransactionsScreen() {
  ...
  const { transactions: apiTransactions, isLoading, pagination } = useAppSelector((state) => state.transactions);
